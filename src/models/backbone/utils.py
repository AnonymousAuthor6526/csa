...
def get_backbone_info(backbone):
    info = {
        'resnet50-none': {'n_output_channels': 2048, 'downsample_rate': 32},
        'resnet50-conv': {'n_output_channels': 480, 'downsample_rate': 4},
        'resnet50-interp': {'n_output_channels': 3840, 'downsample_rate': 4},
        'hrnet_lite-conv': {'n_output_channels': 320, 'downsample_rate': 4},
        'hrnet_w32-conv': {'n_output_channels': 480, 'downsample_rate': 4},
        'hrnet_w48-conv': {'n_output_channels': 480, 'downsample_rate': 4},
