...
def hrnet_w32(
        pretrained=True,
        pretrained_ckpt=os.path.join(CONFIG_HOME, 'data/pretrained_models/pose_coco/pose_hrnet_w32_256x192.pth'),
        downsample=False,
        use_conv=False,
):
...
def hrnet_w48(
        pretrained=True,
        pretrained_ckpt=os.path.join(CONFIG_HOME, 'data/pretrained_models/pose_coco/pose_hrnet_w48_256x192.pth'),
        downsample=False,
        use_conv=False,
):
