...
we provide a documented command line wrapper 'train.py', then you can use the command line 
...
we provide a documented command line wrapper 'train.py',if you want to our code, you must go to the configs/vit_train.yaml ,set the RUN_TEST = True, then you can use the command line 
python train.py --cfg configs/vit_train.yaml
to train our model
